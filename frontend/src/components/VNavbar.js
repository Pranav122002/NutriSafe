    ...
    return (<>
        {user && (
            <div className="vnavbarr pt-16 min-w-[18rem] h-screen bg-white shadow-lg ">
                ...
                <NavLink to="/chat" className="w-11/12 ml-3 flex hover:pl-2 hover:mr-2 rounded hover:bg-gray-100 mt-1.5 " >
                    <img className="h-6 m-3" src="./diseases.png" alt="" />
                    <h1 className="text-base text-gray-700  pt-3 pb-3 tracking-tight font-medium ">Chat</h1>
                </NavLink>

                <NavLink to="/blogposts" className="w-11/12 ml-3 flex hover:bg-gray-100 rounded mt-1.5">
                ...
                >
                    ...
                    <h1 className="pl-1 pt-3 pb-3 font-medium text-red-500 text-base tracking-tight">Logout</h1>
                </div>
