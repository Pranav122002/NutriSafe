...
const Landing = () => {
  const [text] = useTypewriter({
    words: ['Uninterrupted Access to Your Allergy-Safe World', 'Your Culinary Companion, Anytime, Anywhere.', 'Navigating Stores with Ease - Your Guide to Allergy-Friendly Aisles and Sections ', 'Discover What Others with Allergies Love - Personalized Recommendations for Your Palate.'],
    loop: 10,
...
consume- thus saving time.</p>
     ...
     data-aos-duration="2000" className="flexitem w-1/3">
      ...
      <div className="bottom w-full h-40 p-1">
        <h1 className="text-white text-center mt-2 font-Danc italic">NutriSafe</h1>
